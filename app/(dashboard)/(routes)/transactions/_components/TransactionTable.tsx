  ...
  return (
    <div className="w-full relative">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Successful">   <span
                      className="w-2 h-2 rounded-full "
                      style={{
                        backgroundColor: "#4CAF50" 
                      }}
                    /> Successful</SelectItem>
                      <SelectItem value="Pending">   <span
                      className="w-2 h-2 rounded-full "
                      style={{
                        backgroundColor: "#FF8C00" 
                      }}
                    /> Pending</SelectItem>
                      <SelectItem value="Failed"> <span
                      className="w-2 h-2 rounded-full "
                      style={{
          ...
          <TableBody>
            {paginatedData.map((item) => (
              <TableRow key={item.sN}>
                ...
                <TableCell>{item.webhookStatus}</TableCell>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem onClick={() => setSelectedTransaction(item)}><View /> View</DropdownMenuItem>
      ...
      <TransactionDetailsModal
        ...
        setSelectedTransaction={setSelectedTransaction} // Explicitly passed
      />
    </div>
  );
}